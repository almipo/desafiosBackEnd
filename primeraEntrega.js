...
if(this.products.lenght === 0){
    ...
    product.id = this.products.lenght + 1
}
...
getproductsById (id){
    const validateid = this.products.find(produc => produc.id === id)
    if(validateid){
